...
from instances.errors import UserNotFoundError
...
class Field:
    ...
    def __getstate__(self):
        # Define what data to serialize
        state = self.__dict__.copy()
        return state

    def __setstate__(self, state):
        # Define how to deserialize and reconstruct the object
        self.__dict__ = state
...
class Birthday(Field):
    def __init__(sefl, value: str) -> None:
